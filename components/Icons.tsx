...
export const SparklesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="m10.5 21 1.902-1.902a1.875 1.875 0 0 1 2.652 0L17.5 21M6.75 10.5 4.848 8.598a1.875 1.875 0 0 1 0-2.652L6.75 4.5m10.5 6-1.902 1.902a1.875 1.875 0 0 1-2.652 0L12.5 10.5m4.5-6-1.902-1.902a1.875 1.875 0 0 0-2.652 0L10.5 4.5" />
    </svg>
);
